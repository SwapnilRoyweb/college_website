            ...
            <div className="w-full flex flex-col items-center justify-evenly lg:flex-row gap-10">
                ...
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-black bg-opacity-90">
                    <div className="card-body">
                        <h1 className="text-4xl font-bold text-center text-white mb-5">Sign-In now!</h1>
                        ...
                        <div className="form-control mt-6">
                            <button className="btn btn-warning transition ease-in-out delay-150 border border-white hover:-translate-y-1 hover:scale-110 hover:bg-white hover:text-black duration-300">Sign-In</button>
                        </div>
                        <p className='text-white text-center mt-3'>Already have an Account? Please <Link to='/register'><span className='text-yellow-500'>Sign-Up</span></Link></p>
